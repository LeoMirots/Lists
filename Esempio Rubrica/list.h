...
typedef struct contatti {
	char nome[50];
	char numero[50];
} contatto;

typedef contatto element; /*Definizione del tipo di dato degli elementi;*/
...
extern list destroy(list l);							/*Accetta una lista(puntatore ad oggetto) come parametro, ritorna la lista completa senza l;*/
