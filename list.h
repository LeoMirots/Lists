...
extern void bubble_sort(list l);        /*Ordina la lista secondo l'ordine di grandezzi degli elementi;*/
void swap(list a, list b);              /*Scambia i valori dei nodi;*/
...
extern bool empty2(list2 l);								/*Ritorna true se la lista passata come parametro � vuota, altrimenti ritorna false;*/

extern bool detect2(element2 e, list2 l);					/*Ritorna true se l'elemento e � presente nella lista l, altrimenti ritorna false;*/
extern list2 search2(element2 e, list2 l);					/*Se l'elemento e � presente nella lista l, ritorna un puntatore a quell'oggetto, altrimenti ritorna NULL;*/
...
extern list2 difference2(list2 l1, list2 l2);				/*Ritorna una lista uguale a l1, che per� non contiene gli elementi che l1 ha in comune con l2*/
...
extern bool empty3(list3 l);								/*Ritorna true se la lista passata come parametro � vuota, altrimenti ritorna false;*/

extern bool detect3(element3 e, list3 l);					/*Ritorna true se l'elemento e � presente nella lista l, altrimenti ritorna false;*/
extern list3 search3(element3 e, list3 l);					/*Se l'elemento e � presente nella lista l, ritorna un puntatore a quell'oggetto, altrimenti ritorna NULL;*/
...
extern list3 difference3(list3 l1, list3 l2);				/*Ritorna una lista uguale a l1, che per� non contiene gli elementi che l1 ha in comune con l2*/
